/**
 * PVGIS Irradiation API Integration Tests
 */
...
describe('PVGIS Irradiation API Integration', () => {
  beforeEach(() => {
  ...
  it('should handle valid irradiation request', async () => {
    ...
    expect(data).toHaveProperty('irradiation');
    expect(data.irradiation).toHaveProperty('daily');
    expect(data.irradiation).toHaveProperty('monthly');
    expect(data.irradiation).toHaveProperty('annual');
    expect(data.irradiation).toHaveProperty('sun_hours');
